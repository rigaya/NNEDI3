...
void computeNetwork0_AVX2(const float* input, const float* weights, uint8_t* d);
...
void dotProd_m32_m16_AVX2(const float* data, const float* weights, float* vals, int n, int len, const float* istd);
void dotProd_m48_m16_AVX2(const float* data, const float* weights, float* vals, int n, int len, const float* istd);
...
void e0_m16_AVX2(float* values, int n);
void e1_m16_AVX2(float* values, int n);
void e2_m16_AVX2(float* values, int n);

void castScale_AVX2(const float* values, const float* scale, uint8_t* dst,
    uint32_t minimum, uint32_t maximum);
void castScale_AVX2_16(const float* values, const float* scale, uint16_t* dst,
    uint32_t minimum, uint32_t maximum);
...
void weightedAvgElliottMul5_m16_AVX2(const float* weights, int n, float* mstd);

void extract_m8_AVX2(const uint8_t* src, int stride, int xdia, int ydia, float* mstd, float* input);
...
void extract_m8_AVX2_16(const uint8_t* src, int stride, int xdia, int ydia, float* mstd, float* input);
void extract_m8_AVX2_32(const uint8_t* src, int stride, int xdia, int ydia, float* mstd, float* input);
