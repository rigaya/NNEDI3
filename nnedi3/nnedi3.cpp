...
#define SSE2_ASM_AVAILABLE ENABLE_SSE2
#define AVX_ASM_AVAILABLE ENABLE_AVX
#define AVX2_ASM_AVAILABLE ENABLE_AVX2

#if NNEDI3_X86 && !(defined(_WIN32) || defined(_WIN64))
...
extern "C" void castScale_AVX_16(const float *val, const float *scale, uint16_t *dstp,const uint32_t val_min,const uint32_t val_max);
...
extern "C" void extract_m8_AVX_32(const uint8_t *srcp, const int stride, const int xdia, const int ydia, float *mstd, float *input);
extern "C" void extract_m8_i16_AVX(const uint8_t *srcp,const int stride,const int xdia,const int ydia,float *mstd,float *inputf);
extern "C" void extract_m8_i16_AVX_16(const uint8_t *srcp, const int stride, const int xdia, const int ydia, float *mstd, float *inputf);
extern "C" void extract_m8_i16_AVX_16_2(const uint8_t *srcp, const int stride, const int xdia, const int ydia, float *inputf,int32_t *sum,int64_t *sumsq);
extern "C" void dotProd_m32_m16_AVX(const float *data,const float *weights,float *vals,const int n,const int len,const float *istd);
...
extern "C" void dotProd_m32_m16_i16_AVX512VNNI_LargeGeneric_ASM(const float *dataf,const float *weightsf,float *vals,const int n,const int len,const float *istd);
...
#if !(defined(_WIN32) || defined(_WIN64))
// Linux ÔøΩ≈ÇÔøΩ CÔøΩAAVX2+FMA3ÔøΩAAVX-VNNIÔøΩAAVX512ÔøΩnÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩJÔøΩÔøΩÔøΩÔøΩB
static_assert(nnedi3_backend::select_linux_backend(0, CPUF_AVX2 | CPUF_FMA3).normalized_opt == 6, "Linux ÔøΩÃéÔøΩÔøΩÔøΩÔøΩIÔøΩÔøΩÔøΩ AVX2+FMA3 ÔøΩÔøΩIÔøΩ◊Ç‹ÇÔøΩÔøΩÔøΩ");
static_assert(nnedi3_backend::select_linux_backend(0, CPUF_AVX2 | CPUF_FMA3 | nnedi3_backend::CPU_AVXVNNI).normalized_opt == 8, "Linux ÔøΩÃéÔøΩÔøΩÔøΩÔøΩIÔøΩÔøΩÔøΩ AVX-VNNI ÔøΩÔøΩIÔøΩ◊Ç‹ÇÔøΩÔøΩÔøΩ");
static_assert(nnedi3_backend::select_linux_backend(0, CPUF_AVX2).normalized_opt == 1, "Linux ÔøΩÔøΩ FMA3 ÔøΩ»ÇÔøΩÔøΩÔøΩ AVX2 ÔøΩÔøΩIÔøΩÔøΩÔøΩÔøΩƒÇÔøΩÔøΩ‹ÇÔøΩ");
static_assert(nnedi3_backend::select_linux_backend(4, CPUF_AVX2 | CPUF_FMA3).normalized_opt == 1, "Linux ÔøΩÔøΩ opt=2,3,4 ÔøΩÔøΩ C ÔøΩ÷êÔøΩÔøΩKÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩKÔøΩvÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ‹ÇÔøΩ");
static_assert(nnedi3_backend::select_linux_backend(5, CPUF_AVX2 | CPUF_FMA3).normalized_opt == 6, "Linux ÔøΩÔøΩ opt=5 ÔøΩÔøΩ AVX2+FMA3 ÔøΩ÷êÔøΩÔøΩKÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩKÔøΩvÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ‹ÇÔøΩ");
static_assert(nnedi3_backend::select_linux_backend(7, CPUF_FMA3).normalized_opt == 1, "Linux ÔøΩÔøΩ AVX2 ÔøΩ»ÇÔøΩÔøΩÔøΩ FMA3 ÔøΩÔøΩIÔøΩÔøΩÔøΩÔøΩƒÇÔøΩÔøΩ‹ÇÔøΩ");
static_assert(!nnedi3_backend::uses_simd_layout(nnedi3_backend::kernel_set_from_opt(1).predictor_weights), "C ÔøΩ≈Ç…ÇÔøΩ neuron-major ÔøΩÃèdÔøΩ›ÇÔøΩÔøΩKÔøΩvÔøΩ≈ÇÔøΩ");
static_assert(nnedi3_backend::uses_avx2_layout(nnedi3_backend::kernel_set_from_opt(6).predictor_weights), "AVX2+FMA3 ÔøΩ≈Ç…ÇÔøΩ AVX2 ÔøΩzÔøΩÔøΩÃèdÔøΩ›ÇÔøΩÔøΩKÔøΩvÔøΩ≈ÇÔøΩ");
static_assert(nnedi3_backend::uses_avx2_layout(nnedi3_backend::kernel_set_from_opt(8).predictor_weights), "AVX-VNNI ÔøΩ≈Ç…ÇÔøΩ AVX2 ÔøΩzÔøΩÔøΩÃèdÔøΩ›ÇÔøΩÔøΩKÔøΩvÔøΩ≈ÇÔøΩ");
#endif
...
static int detectVnniCpuFlags()
{
	...
	// ÉrÉãÉhéûÇ…AVX-VNNIÇñ≥å¯âªÇµÇΩèÍçáÇÕÅACPUÇ™ëŒâûÇµÇƒÇ¢ÇƒÇ‡ïÒçêÇµÇ»Ç¢
	if (leaf7[0] >= 1)
	{
		__cpuidex(leaf7, 7, 1);
		if ((leaf7[0] & (1 << 4)) != 0)
	...
	etype(_etype),pscrn(_pscrn),threads(_threads),opt(_opt),fapprox(_fapprox),sleep(_sleep),avsp(_avsp)
{
	...
	for (int i=0; i<2; i++)
	{
      ...
      // CUDAÔøΩpÔøΩ…ïÔøΩÔøΩ◊ë÷ÇÔøΩÔøΩOÔøΩÃÉfÔøΩ[ÔøΩ^ÔøΩÔøΩÔøΩÔøΩÔøΩƒÇÔøΩÔøΩÔøΩ
...
void dotProdS_C(const float *dataf, const float *weightsf, float *vals, const int n, const int len, const float *scale)
{
	...
	for (int i=0; i<n; i++)
	{
		...
		int32_t sum;
		// SIMDÔøΩ≈Ç∆ìÔøΩÔøΩÔøΩ32bit wrapÔøΩÔøΩÔøΩ ÇÔøΩAÔøΩÔøΩÔøΩÔøΩ`ÔøΩÔøΩÔøΩÔøΩ»ÇÔøΩÔøΩ≈ïÔøΩÔøΩÔøΩÔøΩtÔøΩÔøΩÔøΩlÔøΩ÷ñﬂÇÔøΩÔøΩB
...
int processLine0_AVX_32(const uint8_t *tempu, int width, uint8_t *dstp, const uint8_t *src3p, const int src_pitch)
{
	int count;
	const int width_m = ((width+3) >> 2) << 2;

	if (width_m!=0) count=processLine0_AVX_ASM_32(tempu,width_m,dstp,src3p,src_pitch);
	else count=0;
	...
	const float *istd)
{
	...
	else if (len == 96 && n >= 256)
		dotProd_m32_m16_i16_AVX512VNNI_LargeGeneric_ASM(
			data, weights, vals, n, len, istd);
...
void extract_m8_i16_C_16_3(const uint8_t *srcp, const int stride, const int xdia, const int ydia, float *mstd, float *inputf)
{
	...
	extract_m8_i16_AVX_16_2(srcp,stride,xdia,ydia,inputf,&sum,&sumsq);
