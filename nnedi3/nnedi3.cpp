...
#if !(defined(_WIN32) || defined(_WIN64))
// Linux �ł� C�AAVX2+FMA3�AAVX-VNNI�AAVX512�n��������J����B
static_assert(nnedi3_backend::select_linux_backend(0, CPUF_AVX2 | CPUF_FMA3).normalized_opt == 6, "Linux �̎����I��� AVX2+FMA3 ��I�ׂ܂���");
static_assert(nnedi3_backend::select_linux_backend(0, CPUF_AVX2 | CPUF_FMA3 | nnedi3_backend::CPU_AVXVNNI).normalized_opt == 8, "Linux �̎����I��� AVX-VNNI ��I�ׂ܂���");
static_assert(nnedi3_backend::select_linux_backend(0, CPUF_AVX2).normalized_opt == 1, "Linux �� FMA3 �Ȃ��� AVX2 ��I����Ă��܂�");
static_assert(nnedi3_backend::select_linux_backend(4, CPUF_AVX2 | CPUF_FMA3).normalized_opt == 1, "Linux �� opt=2,3,4 �� C �֐��K������K�v������܂�");
static_assert(nnedi3_backend::select_linux_backend(5, CPUF_AVX2 | CPUF_FMA3).normalized_opt == 6, "Linux �� opt=5 �� AVX2+FMA3 �֐��K������K�v������܂�");
static_assert(nnedi3_backend::select_linux_backend(7, CPUF_FMA3).normalized_opt == 1, "Linux �� AVX2 �Ȃ��� FMA3 ��I����Ă��܂�");
static_assert(!nnedi3_backend::uses_simd_layout(nnedi3_backend::kernel_set_from_opt(1).predictor_weights), "C �łɂ� neuron-major �̏d�݂��K�v�ł�");
static_assert(nnedi3_backend::uses_avx2_layout(nnedi3_backend::kernel_set_from_opt(6).predictor_weights), "AVX2+FMA3 �łɂ� AVX2 �z��̏d�݂��K�v�ł�");
static_assert(nnedi3_backend::uses_avx2_layout(nnedi3_backend::kernel_set_from_opt(8).predictor_weights), "AVX-VNNI �łɂ� AVX2 �z��̏d�݂��K�v�ł�");
#endif
...
void dotProdS_C(const float *dataf, const float *weightsf, float *vals, const int n, const int len, const float *scale)
{
	...
	for (int i=0; i<n; i++)
	{
		...
		int32_t sum;
		// SIMD�łƓ���32bit wrap���ʂ�A����`����Ȃ��ŕ����t���l�֖߂��B
